...
MasonHub provides two powerful API interfaces:
...
<CardGroup cols={2}>
  <Card
    ...
    icon="code"
  >
    Traditional REST endpoints with JSON payloads at `/{account}/api/v1/`
  </Card>
  <Card
    title="GraphQL API (v2)"
    icon="diagram-project"
  >
    Modern GraphQL interface with flexible queries at `/api/v2/graphql`
  </Card>
</CardGroup>
...
### Core Resources
* [GraphQL API](/api-reference/graphql): Modern GraphQL interface for flexible queries and real-time data access
